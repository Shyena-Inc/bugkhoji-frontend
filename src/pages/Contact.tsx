            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-slate-600 dark:text-slate-300">
                  Whether you're a security researcher, organization, or just curious about our platform, 
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 dark:text-slate-300">hello@BugKhoji🔍.com</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
