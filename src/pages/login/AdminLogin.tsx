...
import { Eye, EyeOff, Loader2, Mail, Lock, AlertCircle, ArrowLeft, Shield } from "lucide-react"
...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      ErrorHandler.logError(error, "Admin login");
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="email"
                    type="email"
                    placeholder="admin@bugkhoji.com"
