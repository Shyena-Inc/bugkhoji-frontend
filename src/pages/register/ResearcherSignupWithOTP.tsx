...
import type { ResearcherRegisterFormData } from '@/types/auth';
import api from '@/utils/api';

export default function ResearcherSignupWithOTP() {
  ...
  const [formData, setFormData] = useState<ResearcherRegisterFormData>({
    email: '',
    username: '',
    firstName: '',
    lastName: '',
  ...
  const handleOTPVerified = async () => {
    ...
    try {
      ...
      const payload: ResearcherRegisterFormData = {
        ...formData,
        termsAccepted: acceptTerms,
      };
      
      await registerResearcher(payload);
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Register as Researcher</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  className={`pl-10 ${fieldErrors.username ? 'border-red-300' : ''}`}
                  required
                />
              </div>
