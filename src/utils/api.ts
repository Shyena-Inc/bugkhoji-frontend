...
export const endpoints = {
  ...
  researcher: {
    ...
    reports: {
      all: (page: number = 1) => `/researcher/reports?page=${page}`,
      draft: '/researcher/reports/draft',
      submitted: '/researcher/reports/submitted',
      inProgress: '/researcher/reports/in-progress',
      resolved: '/researcher/reports/resolved',
      create: '/researcher/reports',
      update: (id: string) => `/researcher/reports/${id}`,
      delete: (id: string) => `/researcher/reports/${id}`,
